<%--The page that displays the reserved result --%>
		...
		<button onclick="history.back()" class = "btn btn-success">Back</button>
			...
			<table class="table table-bordered">
				...
				try{
					  ...
					  String query = "select reserveid,carid,username,carname,cartype,reserve_from,reserve_till,days from ReserveTable WHERE username = ? AND status = ?";
				...
				<td><a href="cancelReservationMember?carid=<%=rs.getString("carid") %>&username=<%=rs.getString("username") %>" class = "btn btn-success">Cancel</a></td>
				</tr>
				<%
					  }
					  connection.close();
