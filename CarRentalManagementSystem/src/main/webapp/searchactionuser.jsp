...
List<Car> list = CarDao.searchCaruser(ob);
	...
	<div class="row">
		...
		<div class="container">
			...
			<div class="container text-center">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<a href = "bookingDetailsuser.jsp?username=<%=username %>" class = "btn btn-success">Booked Details</a>
			</div>
			<br>
			<table class="table table-bordered">
				...
				<td> <a href="bookform.jsp?carid=${u.getCarid() }&username=<%=username %>" class = "btn btn-success">Book</a></td>
				</tr>
				</c:forEach>
			</table>
		</div>
