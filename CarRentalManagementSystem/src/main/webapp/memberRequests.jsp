			...
			<table class="table table-bordered" style="table-layout:auto;width:100%;">
				...
				<%
				  try{
					  ...
					  String query = "select * from memberRequest ";
				...
				<td> <a href="acceptMember?requestid=<%=rs.getString("requestid") %>" class = "btn btn-success">Accept</a></td>
				</tr>
				<%
				  }
					  connection.close();
